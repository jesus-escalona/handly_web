...
class Signup extends Component {
    ...
    render() {
        ...
        return (
            <Modal centered size="tiny" trigger={<Button className='signup' >Sign Up</Button>} onClose={this.handleClose}>
                <Modal.Header>
...
export default connect(mapStateToProps, {signUpUser, setMessages})(Signup)
